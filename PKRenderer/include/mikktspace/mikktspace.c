...
#ifdef _MSC_VER
#  define MIKTT_NOINLINE __declspec(noinline)
#else
#  define MIKTT_NOINLINE __attribute__ ((noinline))
#endif

// it is IMPORTANT that this function is called to evaluate the hash since
// inlining could potentially reorder instructions and generate different
// results for the same effective input value fVal.
static MIKTT_NOINLINE int FindGridCell(const float fMin, const float fMax, const float fVal)
{
