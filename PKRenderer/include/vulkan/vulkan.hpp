...
#  endif
  ...
  public:
    ...
    void vkDestroyPipelineLayout( VkDevice                      device,
                                  ...
                                  const VkAllocationCallbacks * pAllocator ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkDestroyPipelineLayout( device, m_pipelineLayout, pAllocator );
    }
...
namespace std
{
  ...
  {
    std::size_t operator()( VULKAN_HPP_NAMESPACE::PipelineLayout const & m_pipelineLayout ) const VULKAN_HPP_NOEXCEPT
    {
      return std::hash<VkPipelineLayout>{}( static_cast<VkPipelineLayout>( m_pipelineLayout ) );
    }
  };
