...
#include "EntityDatabaseNew.h"

namespace PK
{

    EntitiesDatabase::Identifier EntitiesDatabase::NewEntity(uint32_t entityIndex)
    {
    ...
    void EntitiesDatabase::Delete(uint32_t entityId)
    {
    ...
    void EntitiesDatabase::DeleteType(uint32_t typeIndex)
    {
    ...
    uint32_t* EntitiesDatabase::GetEntityIdStream(uint32_t entityIndex)
    {
        auto* comp = &m_compositions[entityIndex].value;
    ...
    void EntitiesDatabase::ReserveEntitities(uint32_t entityIndex, size_t entryCount)
    {
        auto* comp = &m_compositions[entityIndex].value;
    ...
    void EntitiesDatabase::UpdateViewIndices(uint32_t viewIndex)
    {
