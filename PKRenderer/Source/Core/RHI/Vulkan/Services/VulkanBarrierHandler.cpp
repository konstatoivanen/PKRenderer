...
namespace PK
{
    ...
    uint64_t VulkanBarrierHandler::TInfo<VkBuffer>::Merge(uint64_t a, uint64_t b)
    {
        ...
        return Memory::BitCast<urect1D, uint64_t>(o);
    }
    ...
    uint64_t VulkanBarrierHandler::TInfo<VkImage>::Merge(uint64_t a, uint64_t b)
    {
        ...
        return Memory::BitCast<urect2D, uint64_t>(o);
    }
    ...
    {
        auto rangeo = Memory::BitCast<uint64_t, urect1D>(recordOld.range);
        auto rangen = Memory::BitCast<uint64_t, urect1D>(recordNew.range);
    ...
    {
        auto rangeo = Memory::BitCast<uint64_t, urect2D>(recordOld.range);
        auto rangen = Memory::BitCast<uint64_t, urect2D>(recordNew.range);
        rangeo.xmax += rangeo.xmin;
