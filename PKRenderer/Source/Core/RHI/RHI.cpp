...
namespace PK
{
    ...
    RHIShaderScope RHI::CreateShader(void* base, PK::Assets::Shader::PKShaderVariant* pVariant, const char* name) { return RHIDriver::Get()->CreateShader(base, pVariant, name); }
