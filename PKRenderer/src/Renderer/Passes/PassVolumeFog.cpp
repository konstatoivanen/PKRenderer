...
namespace PK::Renderer::Passes
{
    ...
    void PassVolumeFog::ComputeDensity(CommandBufferExt cmd, const Math::uint3& resolution)
    {
    ...
    void PassVolumeFog::Compute(CommandBufferExt cmd, const Math::uint3& resolution)
    {
        cmd->BeginDebugScope("Fog.InjectionScattering", PK_COLOR_MAGENTA);
    ...
    void PassVolumeFog::Render(CommandBufferExt cmd, Texture* destination)
    {
