...
namespace PK::Renderer
{
    ...
    void EntityCullSequencerProxy::CullRayTracingGeometry(ScenePrimitiveFlags mask, const Math::BoundingBox& bounds, bool useBounds, QueueType queue, AccelerationStructure* structure)
    {
