...
namespace PK::Rendering
{
                       ...
                       public Utilities::ISingleton<HashCache>
    {
        ...
        DECLARE_HASH(pk_ViewToProj)
        DECLARE_HASH(pk_WorldToProj)
        DECLARE_HASH(pk_WorldToProj_NoJitter)
        DECLARE_HASH(pk_WorldToProjPrev)
        DECLARE_HASH(pk_WorldToProjPrev_NoJitter)
        DECLARE_HASH(pk_ViewToProjDelta)
