...
namespace PK::Rendering
{
                       ...
                       public Utilities::ISingleton<HashCache>
    {
        ...
        DECLARE_HASH(pk_GI_Meta_Read)
        DECLARE_HASH(pk_GI_Meta_Write)
        DECLARE_HASH(pk_GI_RayHits)
        DECLARE_HASH(pk_GI_SHY_Read)
        DECLARE_HASH(pk_GI_SHY_Write)
        DECLARE_HASH(pk_GI_CoCg_Read)
        DECLARE_HASH(pk_GI_CoCg_Write)
