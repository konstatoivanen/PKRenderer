...
namespace PK::Rendering
{
                       ...
                       public Utilities::ISingleton<HashCache>
    {
        ...
        DECLARE_HASH(pk_GI_ScreenDataRead)
        ...
        DECLARE_HASH(pk_Fog_Anisotropy)
        DECLARE_HASH(pk_Fog_DensityConstant)
        DECLARE_HASH(pk_Fog_DensityHeightExponent)
        DECLARE_HASH(pk_Fog_DensityHeightOffset)
        DECLARE_HASH(pk_Fog_DensityHeightAmount)
        DECLARE_HASH(pk_Fog_DensityNoiseAmount)
        DECLARE_HASH(pk_Fog_DensityNoiseScale)
        DECLARE_HASH(pk_Fog_DensityAmount)
