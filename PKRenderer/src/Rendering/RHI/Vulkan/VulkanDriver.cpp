...
namespace PK::Rendering::RHI::Vulkan
{
    ...
    void VulkanDriver::DisposePooledImageView(VulkanImageView* view, const FenceRef& fence) const
    {
        auto deleter = [](void* v)
        {
            RHI::Driver::GetNative<VulkanDriver>()->imageViewPool.Delete(reinterpret_cast<VulkanImageView*>(v));
        };
    ...
    void VulkanDriver::DisposePooledImage(VulkanRawImage* image, const FenceRef& fence) const
    {
        auto deleter = [](void* v)
        {
            RHI::Driver::GetNative<VulkanDriver>()->imagePool.Delete(reinterpret_cast<VulkanRawImage*>(v));
        };
    ...
    void VulkanDriver::DisposePooledBuffer(VulkanRawBuffer* buffer, const FenceRef& fence) const
    {
        auto deleter = [](void* v)
        {
            RHI::Driver::GetNative<VulkanDriver>()->bufferPool.Delete(reinterpret_cast<VulkanRawBuffer*>(v));
        };
