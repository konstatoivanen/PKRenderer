...
namespace PK::Rendering::RHI::Vulkan::Objects
{
    ...
    void VulkanCommandBuffer::DrawMeshTasks(const Math::uint3& dimensions)
    {
        ValidatePipeline();
        MarkLastCommandStage(VK_PIPELINE_STAGE_ALL_GRAPHICS_BIT);
    ...
    void VulkanCommandBuffer::DrawMeshTasksIndirect(const Buffer* indirectArguments, size_t offset, uint32_t drawCount, uint32_t stride)
    {
        static Services::VulkanBarrierHandler::AccessRecord record{};
    ...
    void VulkanCommandBuffer::DispatchRays(const Math::uint3& dimensions)
    {
    ...
    void VulkanCommandBuffer::Blit(Texture* src, Texture* dst, const TextureViewRange& srcRange, const TextureViewRange& dstRange, FilterMode filter)
    {
    ...
    void VulkanCommandBuffer::UploadTexture(Texture* texture, const void* data, size_t size, ImageUploadRange* ranges, uint32_t rangeCount)
    {
    ...
    void VulkanCommandBuffer::ValidateWindowPresent(Window* window)
    {
