...
namespace PK::Rendering::VulkanRHI::Objects
{
    ...
    struct VulkanCommandBuffer : public VulkanRawCommandBuffer, public CommandBuffer
    {
        ...
        void BeginRenderPass() override final { BeginRenderPass(renderState->PrepareRenderPass()); }
        void EndRenderPass() override final { VulkanRawCommandBuffer::EndRenderPass(); }
