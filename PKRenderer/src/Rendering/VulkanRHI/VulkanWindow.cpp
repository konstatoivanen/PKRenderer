...
namespace PK::Rendering::VulkanRHI
{
        ...
        m_driver(driver)
    {
        ...
        VK_ASSERT_RESULT_CTX(vkGetPhysicalDeviceSurfaceSupportKHR(m_driver->physicalDevice, m_driver->queueFamilies[QueueType::Present].index, m_surface, &presentSupported), "Surface support query failure!");
