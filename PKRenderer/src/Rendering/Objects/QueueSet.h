...
namespace PK::Rendering::Objects
{
    struct QueueSet : public PK::Utilities::NoCopy
    {
        ...
        virtual void QueueSync(Structs::QueueType from, Structs::QueueType to) = 0;
        virtual Objects::CommandBuffer* SubmitSynced(Structs::QueueType source, Structs::QueueType destination) = 0;
