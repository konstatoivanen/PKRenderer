...
{
    typedef Utilities::Ref<struct RHIAccelerationStructure> RHIAccelerationStructureRef;

    struct RHIAccelerationStructure : public Utilities::NoCopy, public Utilities::NativeInterface<RHIAccelerationStructure>
    {
