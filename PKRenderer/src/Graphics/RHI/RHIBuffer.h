...
{
    typedef Utilities::Ref<struct RHIBuffer> RHIBufferRef;

    struct RHIBuffer : public Utilities::NoCopy, public Utilities::NativeInterface<RHIBuffer>
    {
        virtual ~RHIBuffer() = 0;
    ...
    protected:
        RHIBuffer(size_t size, BufferUsage usage) : m_usage(usage), m_size(size) {}
