...
PK_FORWARD_DECLARE_IN_NAMESPACE(PK::Graphics::RHI::Vulkan::Objects, class VulkanRenderState)
...
namespace PK::Graphics::RHI::Vulkan::Objects
{
    struct VulkanCommandBuffer : public RHICommandBuffer
    {
        ...
        void SetIndexBuffer(const RHIBuffer* buffer, size_t offset, ElementType indexType) final;
        ...
        void Clear(RHITexture* dst, const TextureViewRange& range, const Math::uint4& value) final;
        ...
        void UploadTexture(RHITexture* texture, const void* data, size_t size, ImageUploadRange* ranges, uint32_t rangeCount) final;
