...
#include "Graphics/RHI/Vulkan/Objects/VulkanRenderState.h"
...
namespace PK::Graphics::RHI::Vulkan::Objects
{
    ...
    void VulkanCommandBuffer::SetIndexBuffer(const RHIBuffer* buffer, size_t offset, ElementType indexType)
    {
    ...
    void VulkanCommandBuffer::UploadTexture(RHITexture* texture, const void* data, size_t size, ImageUploadRange* ranges, uint32_t rangeCount)
    {
