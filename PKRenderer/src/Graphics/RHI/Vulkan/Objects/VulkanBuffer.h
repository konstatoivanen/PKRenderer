...
PK_FORWARD_DECLARE_IN_NAMESPACE(PK::Graphics::RHI::Vulkan::Objects, class VulkanSparsePageTable)
PK_FORWARD_DECLARE_IN_NAMESPACE(PK::Graphics::RHI::Vulkan::Services, struct VulkanStagingBuffer)
PK_FORWARD_DECLARE_IN_NAMESPACE(PK::Graphics::RHI::Vulkan, struct VulkanSparsePageTable)
