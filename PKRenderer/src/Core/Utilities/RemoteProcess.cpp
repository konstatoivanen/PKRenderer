...
namespace PK
{
    bool RemoteProcess::Execute(const char* executable, const char* arguments, std::string& outError)
    {
    ...
    bool RemoteProcess::Execute(const std::string& executablePath, const std::string& arguments, std::string& outError)
    {
        return RemoteProcess::Execute(executablePath.c_str(), arguments.c_str(), outError);
    }
}
