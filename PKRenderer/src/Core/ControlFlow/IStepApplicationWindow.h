...
namespace PK::Core::ControlFlow
{
    class IStepApplicationOpenFrameWindow : public IStep<ApplicationStep::OpenFrame, PK::Rendering::RHI::Window*>
    {
        ...
        public:
            ...
            virtual void Step(ApplicationStep::OpenFrame token, PK::Rendering::RHI::Window* window) final { OnApplicationOpenFrame(window); }
    };
    ...
    class IStepApplicationUpdateInputWindow : public IStep<ApplicationStep::UpdateInput, PK::Rendering::RHI::Window*>
    {
        ...
        public: 
            ...
            virtual void Step(ApplicationStep::UpdateInput token, PK::Rendering::RHI::Window* window) final { OnApplicationUpdateInput(window); }
    };
    ...
    class IStepApplicationUpdateEnginesWindow : public IStep<ApplicationStep::UpdateEngines, PK::Rendering::RHI::Window*>
    {
        ...
        public: 
            ...
            virtual void Step(ApplicationStep::UpdateEngines token, PK::Rendering::RHI::Window* window) final { OnApplicationUpdateEngines(window); }
    };
    ...
    class IStepApplicationRenderWindow : public IStep<ApplicationStep::Render, PK::Rendering::RHI::Window*>
    {
        ...
        public: 
            ...
            virtual void Step(ApplicationStep::Render token, PK::Rendering::RHI::Window* window) final { OnApplicationRender(window); }
    };
    ...
    class IStepApplicationCloseFrameWindow : public IStep<ApplicationStep::CloseFrame, PK::Rendering::RHI::Window*>
    {
        ...
        public: 
            ...
            virtual void Step(ApplicationStep::CloseFrame token, PK::Rendering::RHI::Window* window) final { OnApplicationCloseFrame(window); }
    };
}